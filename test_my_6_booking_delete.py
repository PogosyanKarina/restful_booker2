...
import test_my_1_booking_token
import test_my_2_booking_post
...
def test_delete_booking_by_id():
    headers = {'Content-Type': 'application/json', 'Cookie': f'token={test_my_1_booking_token.my_token}'}

    with allure.step('Send DELETE request to delete a booking by ID'):
        response = requests.delete(
            f'https://restful-booker.herokuapp.com/booking/{test_my_2_booking_post.my_bookingid}',
            headers=headers
        )
